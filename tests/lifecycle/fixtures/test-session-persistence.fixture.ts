 ...
 *
 * 5 linear steps, no loops, no conditions.
 * Tests the simplest possible execution path.
 */
export const testSessionPersistenceFixture: WorkflowFixture = {
  ...
  stepFixtures: {
    'step-1-alpha': { notesMarkdown: 'ALPHA marker written' },
    'step-2-beta': { notesMarkdown: 'BETA marker written' },
    'step-3-gamma': { notesMarkdown: 'GAMMA marker written' },
    'step-4-delta': { notesMarkdown: 'DELTA marker written' },
    'step-5-final': { notesMarkdown: 'All 4 markers verified' },
  },
};
